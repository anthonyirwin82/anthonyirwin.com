...
<div style="width=400px;max-width=400px">
    <div class="row mb-4">
        ...
        <div class="col-12 col-md-6">
            <img src="/assets/img/about/amstrad-cpc-6128.webp" class="img-fluid rounded" loading="lazy">
        </div>
    </div>

    <div class="row mb-4">
        <div class="col-12 order-2 col-md-6 order-md-1">
            <img src="/assets/img/about/Linux.webp" class="img-fluid rounded" loading="lazy">
        </div>
